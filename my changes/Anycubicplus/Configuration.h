 ...
 * - Extra features
 *
 *M665 R133.40 L271.50
M666 X-0.39 Y0.00 Z-3.89
; Set homed height 283.14mm in config.h Advanced settings can be found in Configuration_adv.h
 *
 *
 *
 *
...
#define MANUAL_Z_HOME_POS 288.8 // Distance between the nozzle to printbed after homing
