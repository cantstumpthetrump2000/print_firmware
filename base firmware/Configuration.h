...
#define STRING_CONFIG_H_AUTHOR "(Otake)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Otake Anycubic Kossel Plus"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -26  //-1.3 //-4.1  // Z offset: -below +above  [the nozzle] -0.5 is lower nozzle than -4.1
...
#define MANUAL_Z_HOME_POS 279.8 // Distance between the nozzle to printbed after homing
